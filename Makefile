...
SERVER_SOURCES = $(COMMON_SOURCES) code/server/main.cpp code/server/server_network.cpp code/server/network.cpp code/server/shared.cpp code/lib/chunk_ring_buffer.cpp
