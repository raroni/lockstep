...
CLIENT_SOURCES = $(COMMON_SOURCES) code/client/main.cpp code/client/network.cpp code/lib/chunk_ring_buffer.cpp code/client/network_events.cpp code/client/network_commands.cpp
