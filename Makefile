...
COMMON_SOURCES = code/common/memory.cpp code/common/network.cpp code/common/serialization.cpp code/lib/assert.cpp code/common/messages.cpp code/common/conversion.cpp
...
CLIENT_SOURCES = $(COMMON_SOURCES) code/client/main.cpp code/client/network.cpp code/lib/chunk_ring_buffer.cpp code/lib/byte_ring_buffer.cpp code/client/network_events.cpp code/client/network_commands.cpp
