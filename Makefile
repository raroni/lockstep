...
COMMON_SOURCES = code/common/shared.cpp code/common/memory.cpp code/common/network.cpp code/common/serialization.cpp code/lib/assert.cpp code/common/messages.cpp
